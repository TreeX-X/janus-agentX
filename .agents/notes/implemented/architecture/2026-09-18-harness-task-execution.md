...
Automatic repair scheduling, portable execution projection into task Notes, external runner launch, desktop evidence UX, Ink integration and shared maintenance conversation control remain incomplete. These limits keep S8 and the standard cutover open. Candidate standards and old assets retain their current lifecycle.
